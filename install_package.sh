...
echo '初始化脚本准备初始化脚本准备初始化脚本准备初始化脚本准备初始化脚本准备初始化脚本准备，/app/script/'
sleep 10
...
cd $download_base_dir
useradd -r nginx
mkdir -p /home/nginx/.ssh $app_base_dir/nginx-conf
cat > /home/nginx/.ssh/authorized_keys <<EOF
ssh-rsa  www@qm-hd2b-walle-0_3
EOF
chown -R nginx.nginx /home/nginx $app_base_dir/nginx-conf
chmod  700 /home/nginx /home/nginx/.ssh
